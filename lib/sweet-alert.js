...
(function(window, document) {
  ...
  window.sweetAlert = window.swal = function() {
    ...
    fixVerticalPosition();
    openModal(params.showCancelButton);
  ...
  function openModal(hasCancel) {
    ...
    // Focus on cancel button if there is one
    var $activeButton = hasCancel ? modal.querySelector('button.cancel') : modal.querySelector('button.confirm');
    $activeButton.focus();
